...
def in_vcf(vcf, gene_prefix, logger, outfile):
    ...
    for line in f_in:
        ...
        CHROM, POS, ID, REF, ALT, QUAL, FILTER, INFO, FORMAT,Female,J2 = line.split("\t")
        modifier_type, modifier, gene = splitInfo(INFO, gene_prefix)
        Female = haplotype_reduce(Female)
        J2 = haplotype_reduce(J2)
...
parser.add_option("--vcf", dest="vcf",
                  default="Hsach_J2_female.snpef.vcf",
                  help="vcf",
                  metavar="FILE")
...
parser.add_option("-o", "--out",
                  dest="outfile",
                  default="Hsach_J2_female.snpef.reduced.vcf",
